...
legend("topright", legend = c("Intercept", "mean(time)", "all param(time)", "seasonality"),
       col = c("black", "steelblue", "goldenrod", "darkolivegreen"), cex = 1, lty = c(2,1,1,1), bty = "n")
...
param_table <- data.frame(
  models = c("Intercept", "Mean(time)", "All_param(time)", "Seasonality"),
  mu = c(resm1c$params[1], resm2c$params[1],resm3c$params[1],  Nitrate[6435,5]),
  sigma = c(resm1c$params[2], resm2c$params[2], resm3c$params[2], Nitrate[6435,6]),
  nu = c(resm1c$params[3], resm2c$params[3], resm3c$params[3], Nitrate[6435,7]),
  tau = c(resm1c$params[4], resm2c$params[4], resm3c$params[4], Nitrate[6435,8])
)
...
legend("topright", legend = c("1963", "1980", "1994"),
       col = c("chocolate", "cornflowerblue", "darkseagreen4"), cex = 1, lty = c(1,1,1), bty = "n")
