...
y <- rSST(n, mu = mu0, sigma = sigma0, nu = nu0, tau = tau_t)
y1 <- rTF2(n, mu = mu0, sigma = sigma0, nu = tau_t)
...
```{r}
SSTdat <- gamlss(y ~ 1, sigma.fo = ~ 1, nu.fo = ~ 1, tau.fo = ~pb(t_scaled), family = SST(), data = dat, 
  method = mixed(5, 200),
  control = gamlss.control(n.cyc = 400, c.crit = 0.01, trace = TRUE)
)

TF2dat <- gamlss(y ~ 1, sigma.fo = ~ 1, nu.fo = ~ 1, tau.fo = ~pb(t_scaled), family = TF2(), data = dat, 
  method = mixed(5, 200),
  control = gamlss.control(n.cyc = 400, c.crit = 0.01, trace = TRUE)
)

SSTdat1 <- gamlss(y ~ 1, sigma.fo = ~ 1, nu.fo = ~ 1, tau.fo = ~pb(t_scaled), family = SST(), data = dat1, 
  method = mixed(5, 200),
  control = gamlss.control(n.cyc = 400, c.crit = 0.01, trace = TRUE)
)

TF2dat1 <- gamlss(y ~ 1, sigma.fo = ~ 1, nu.fo = ~ 1, tau.fo = ~pb(t_scaled), family = TF2(), data = dat1, 
  method = mixed(5, 200),
  control = gamlss.control(n.cyc = 400, c.crit = 0.01, trace = TRUE)
)
```
...
```{r, echo=FALSE}
aic_tbl <- data.frame(
  model = c("SSTdat", "TF2dat", "SSTdat1", "TF2dat1"),
  AIC   = c(GAIC(SSTdat, k = 2), GAIC(TF2dat, k = 2), GAIC(SSTdat1, k = 2), GAIC(TF2dat1, k = 2))
)
print(aic_tbl)
```
...
y <- rSST(n, mu = mu0, sigma = sigma_t, nu = 1, tau = 7)
...
y <- rSST(n, mu = mu_t, sigma = sigma_t, nu = 1, tau = 7)
...
m0 <- gamlss(y ~ 1, sigma.fo = ~ 1, family = SST(), data = dat, trace = FALSE)

# M1: time-varying variance only + constant mean
m1 <- gamlss(y ~ 1, sigma.fo = ~ pb(t_scaled), family = SST(), data = dat, trace = FALSE)

# M2: time-varying mean only + constant variance 
m2 <- gamlss(y ~ pb(t_scaled), sigma.fo = ~ 1, family = SST(), data = dat, trace = FALSE)

# M3: time-varying mean + time-varying variance
m3 <- gamlss(y ~ pb(t_scaled), sigma.fo = ~ pb(t_scaled), family = SST(), data = dat, trace = FALSE)
```
...
y <- rSST(n, mu = mu_t, sigma = sigma_t, nu = nu_const, tau = 7)
...
m4 <- gamlss(y ~ pb(t_scaled), sigma.fo = ~ pb(t_scaled), nu.fo = ~ 1, family = SST(), data = dat,  
  method = mixed(5, 200),
  control = gamlss.control(n.cyc = 400, c.crit = 0.01, trace = FALSE))
```
...
# M4: time-varying mean + time-varying variance + constant skewness
m4 <- gamlss(y ~ pb(t_scaled), sigma.fo = ~ pb(t_scaled), tau.fo = ~ 1, family = SST(),
  method =       mixed(5, 200),
  control = gamlss.control(n.cyc = 400, c.crit = 0.01, trace = FALSE))
```
...
# testing my theory model 
wth <- gamlss(y ~ 1, sigma.fo = ~ 1, nu.fo = ~ 1, tau.fo = ~ 1, family = SST(), data = dat, 
  method =  mixed(5, 200),
  control = gamlss.control(n.cyc = 400, c.crit = 0.01, trace = FALSE))
